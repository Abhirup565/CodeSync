            ...
            <nav className="bg-gray-800 border-b border-gray-700 px-6 py-4 fixed w-screen z-20 font-mono">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                        {isLoggedIn ? (
                            <div onClick={() => { setShowPopup(prev => !prev) }} className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center cursor-pointer">
                ...
                {/* avatar icon popup */}
                {showPopup && <div className="absolute right-15 top-20">
                    <NavIconPopup user={isLoggedIn} />
                </div>}
