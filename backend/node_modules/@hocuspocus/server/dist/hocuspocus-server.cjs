...
class OutgoingMessage {
    ...
    writeCloseMessage(reason) {
        ...
        writeVarUint(this.encoder, exports.MessageType.CLOSE);
    ...
    async apply(document, connection, reply) {
        ...
        switch (type) {
            ...
            case exports.MessageType.SyncReply: {
                ...
                await this.readSyncMessage(message, document, connection, reply, type !== exports.MessageType.SyncReply);
...
class Connection {
    ...
    handleMessage(data) {
        ...
        this.callbacks
            ...
            this.close({
                code: "code" in e ? e.code : common.ResetConnection.code,
                reason: "reason" in e ? e.reason : common.ResetConnection.reason,
            });
        });
    }
}
...
class ClientConnection {
    ...
    hooks, opts, defaultContext = {}) {
        ...
        this.handleQueueingMessage = async (data) => {
            ...
            try {
                ...
                console.error(error);
                this.websocket.close(common.ResetConnection.code, common.ResetConnection.reason);
            }
        };
    ...
    createConnection(connection, document) {
        ...
        const instance = new Connection(connection, hookPayload.request, document, hookPayload.socketId, hookPayload.context, hookPayload.connectionConfig.readOnly);
...
class DirectConnection {
    ...
    async transact(transaction) {
        ...
        await this.instance.storeDocumentHooks(this.document, {
            ...
            requestHeaders: {},
            requestParameters: new url.URLSearchParams(),
            socketId: "server",
        }, true);
    }
    async disconnect() {
...
class Hocuspocus {
    ...
    async handleDocumentUpdate(document, connection, update, request) {
        ...
        if (!connection ||
            connection === "__hocuspocus__redis__origin__") {
            return;
        }
    ...
    storeDocumentHooks(document, hookPayload, immediately) {
        return this.debouncer.debounce(`onStoreDocument-${document.name}`, () => {
    ...
    async openDirectConnection(documentName, context) {
        ...
        uuid.v4(), connectionConfig, context);
...
class Server {
    constructor(configuration, websocketOptions = {}) {
        this.configuration = {
            ...defaultConfiguration,
    ...
    showStartScreen() {
        ...
        const extensions = (_a = this.configuration) === null || _a === void 0 ? void 0 : _a.extensions.map((extension) => {
            var _a, _b;
            return (_a = extension.extensionName) !== null && _a !== void 0 ? _a : (_b = extension.constructor) === null || _b === void 0 ? void 0 : _b.name;
